...
func init() {
	...
	NOAAProducts[NOAAProductID.GOES16_ABI] = PacketData.MakeNOAAProductWithSubProductsAndName(NOAAProductID.GOES16_ABI, "GOES 16 ABI", map[int]PacketData.NOAASubProduct{
		0:  PacketData.MakeSubProduct(0, "None"),
		1:  PacketData.MakeSubProduct(1, "Band 1 - Blue"),
		2:  PacketData.MakeSubProduct(2, "Band 2 - Red"),
		3:  PacketData.MakeSubProduct(3, "Band 3 - Veggie"),
		4:  PacketData.MakeSubProduct(4, "Band 4 - Cirrus"),
		5:  PacketData.MakeSubProduct(5, "Band 5 - Snow/Ice"),
		6:  PacketData.MakeSubProduct(6, "Band 6 - Cloud Plarticle Size"),
		7:  PacketData.MakeSubProduct(7, "Band 7 - Shortwave Window"),
		8:  PacketData.MakeSubProduct(8, "Band 8 - Upper-Level Tropospheric Water Vapor"),
		9:  PacketData.MakeSubProduct(9, "Band 9 - Mid-Level Tropospheric Water Vapor"),
		10: PacketData.MakeSubProduct(10, "Band 10 - Lower-level Water Vapor"),
		11: PacketData.MakeSubProduct(11, "Band 11 - Cloud-Top Phase"),
		12: PacketData.MakeSubProduct(12, "Band 12 - Ozone"),
		13: PacketData.MakeSubProduct(13, "Band 13 - Clean IR (Longwave)"),
		14: PacketData.MakeSubProduct(14, "Band 14 - IR (Longwave)"),
		15: PacketData.MakeSubProduct(15, "Band 15 - Dirty IR (Longwave)"),
		16: PacketData.MakeSubProduct(16, "Band 16 - CO2 Infrared (Longwave)"),
		// Internal for OSP
		99: PacketData.MakeSubProduct(99, "False Color"),
	})
